  ...
  const login = async () => {
    ...
    if (user.success) {
      ...
      if (types.includes("admin")) {
        authCtx.login( {...user.data.admin}, user.data.token, "admin");
        nvaigate("/admin");
      }
      if (types.includes("user")) {
        authCtx.login({...user.data.user}, user.data.token, "user");
        nvaigate("/user");
      }
      if (types.includes("company")) {
        authCtx.login({...user.data.company}, user.data.token, "company");
        nvaigate("/company");
      }
    }
  };
